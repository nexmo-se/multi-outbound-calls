...
connect a third call that can listen to both initial participants and do whispering to the second participant by accessing either of the following URLs (via a web browser or programmatically with HTTP GET).
